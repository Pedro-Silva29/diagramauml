...
public class Main {
    public static void main(String[] args) {
        ...
        Ebook ebook2 = new Ebo'oksAutorais("Livro 2", autor, new Editoras("Editora Y eb1", "CNPJ da Editora Y eb1","end edit eb1","numc edito eb1","cnpj edit eb1"), LocalDate.now(), new ArrayList<String>(), 50.0, new Editoras("jureg ebook1", "email do jureg ebook1","endteste ebook1", "numcontato ebook1","cnpjEbok1"), LocalDateTime.parse("2007-12-03T10:15:30"));

        biblioteca.adicionarEbook(ebook2);
        biblioteca.adicionarEbook(ebook1);

        System.out.println("Todos os Ebooks:");
        ArrayList<Ebook> todosEbooks = biblioteca.listarEbooksAdquiridos();
        for (Ebook ebook : todosEbooks) {
